	...
	?>
		...
		<div class="content">
			...
			<?php $rslt=Services::model()->findAll();  ?>
		<div class="services service-bg">
				  ...
				  <!--  <h2>services</h2> -->
				   <h6>The thing we love to do,for you!</h6>
					...
					?>
					    ...
					    <div class="<?php echo $ab; ?>">
						   <div class="service-info col-md-11">
						   <img src="<?php echo Yii::app()->baseUrl; ?>/images/services/<?php echo $sk['image'];?>">
						      <!-- <span class="glyphicon glyphicon-user"></span> -->
						      <h4><?php echo $sk['title'];?></h4>
						      <p>
							  <?php echo $sk['description'];?>
							  </p>
						   </div>
						</div>
			...
			<div class="clients">
				...
				<ul id="flexiselDemo3">
				<?php foreach( $rslt as $sk) { ?>
				<li><a href="#."><img src="images/portfolio/<?php echo $sk['image']; ?>" /></a></li>
				<?php } ?>
