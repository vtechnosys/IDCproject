...
class Testimonials extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('customer_id, status, testimony, sort_order, date', 'required'),
			array('customer_id, status, sort_order', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, customer_id, status, testimony, sort_order, date', 'safe', 'on'=>'search'),
		);
	}
