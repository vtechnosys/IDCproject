...
<section class="page-title o-hidden pos-r md-text-center" data-bg-color="#fbf3ed" style="background-color: rgb(251, 243, 237);">
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="get-in-touch col-md-6 col-sm-12 col-xs-12 innerhead"><br><br>
        <h1 class="title" style="margin-top:-30px;"><span></span>{{$industries[0]->sub_servicename1}}</h1>
      ...
      <div class="col-lg-6 col-md-12 text-right md-mt-3">
        <nav aria-label="breadcrumb" class="page-breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{$industries[0]->sub_servicename1}}</li>
          </ol>
        </nav>
      </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="about-details">
                  <p style="margin-left:50px;">{{$industries[0]->whyidctechnology}}</p>
              </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-6 col-xs-12" style="border-left:none;border-top:none;border-bottom:none;">
                <div class="about-image">
                <h1 class="mb-4 wow fadeInUp" data-wow-duration="1.5s" style="visibility: visible; animation-duration: 1.5s; animation-name: fadeInUp;"><b>Our other offerings under staffing</b></h1>
                    <!-- <p><b> Solutions aligned to your business needs</b></p> -->
...
if($i%2==0)
{
    $str=$industries[0]->sub_servicename;
    $tr=$s->sub_servicename1;
    $str1=str_replace(' ','-',$tr);
?>
            <div class="col-md-4 col-sm-6 col-xs-12">
              <div class="about-details">
                    ...
                    <ul class="marker-list">
                      <li><a href="/service/{{$str}}/{{$str1}}" style="text-decoration:none;color:black;">{{$s->sub_servicename1}}</a></li>
