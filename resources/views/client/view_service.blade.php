  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="get-in-touch col-md-6 col-sm-12 col-xs-12 innerhead"><br><br>
        <h1 class="title" style="margin-top:-30px;"><span></span>{{$industries[0]->sub_servicename}}</h1>
      ...
      <div class="col-lg-6 col-md-12 text-right md-mt-3">
        <nav aria-label="breadcrumb" class="page-breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{$industries[0]->sub_servicename}}</li>
          </ol>
        </nav>
      </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="col-md-6 hidden-xs">
          ...
          <div class="col-md-6">
            ...
            <p>{!! html_entity_decode($industries[0]->description) !!}</p>
          </div>
...
<!-- End Contact Area -->
<?php
$str=$industries[0]->whyidctechnology;
if($str!="")
{
?>
<!-- about-area start -->
