    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="about-details">
                    <ul class="marker-list">
                      <li>COLLECTIONS & RECEIVABLE MANAGEMENT (CARM)</li>
                      <li>PROFESSIONAL & MANAGERIAL</li>
                      <li>POLITICAL CALL CENTER SERVICES</li>
                      <li>CLINICAL & SCIENTIFIC</li>
                      <li>RECRUITMENT & PROCUREMENT</li>
                    </ul>
                </div>
			      </div>
...
<div class="about-area bg-color area-padding" style="margin-bottom:50px;">
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12" style="border:2px solid grey;height:300px;border-left:none;border-top:none;border-bottom:none;">
                <div class="about-image">
