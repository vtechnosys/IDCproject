    ...
    <div class="row">
        ...
        <div class="row mt-5">
            <section class="get-in-touch col-md-12 col-sm-12 col-xs-12" style="margin:auto;">
               ...
               <form class="contact-form row" action="/employerseekerstore" method="post" enctype="multipart/form-data">
			   {{ csrf_field() }}
                  ...
                  <div class="form-field col-lg-6 ">
                     <input id="company" class="input-text js-input" type="text" required name="company">
                  ...
                  <div class="form-field col-lg-6 ">
                    ...
                    <select class="input-text js-input" required name="service">
                        <option value="">Select Need Services</option>
                        <option value="ASP.net">ASP.net</option>
                        <option value="C#.net">C#.net</option>
                        <option value="Angular">Angular</option>
                    </select>
                    <label class="label" for="phone">Need Services</label>
</div>
