        ...
        <div class="sparkline12-list shadow-reset mg-t-30">
            <div class="sparkline12-hd">
                <div class="main-sparkline12-hd">
                    <h1 class="text-center">Upload Testimonials Details</h1>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="all-form-element-inner">
                                ...
                                @endif    
                            <form method="POST" action="{{action('TestiController@store')}}" enctype="multipart/form-data">
                                {{csrf_field()}} 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <div class="form-select-list">                                                                                               
                                                <input type="text" placeholder="Client Name" name="cname" class="form-control" required/>                                               
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group-inner">
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <label class="login2 pull-right pull-right-pro">Upload Client Image:</label>
                                        </div>
                                        <div class="col-lg-7">
