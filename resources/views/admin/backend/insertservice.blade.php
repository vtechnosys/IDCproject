        ...
        <div class="sparkline12-list shadow-reset mg-t-30">
            <div class="sparkline12-hd">
                <div class="main-sparkline12-hd">
                    <h1 class="text-center">Upload Service Details</h1>
                </div>
            </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <form method="POST" action="{{action('ServiceController@store')}}" enctype="multipart/form-data">
                                ...
                                <div class="form-group-inner">
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <label class="login2 pull-right pull-right-pro">Service Heading:</label>
                                            </div>
                                            <div class="col-lg-7">
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7">
                                                <input type="file" placeholder="Upload File..." name="icon" class="form-control" required/>
