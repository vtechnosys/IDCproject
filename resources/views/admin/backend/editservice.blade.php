        ...
        <div class="sparkline12-list shadow-reset mg-t-30">
            <div class="sparkline12-hd">
                <div class="main-sparkline12-hd">
                    <h1 class="text-center">Update Service Details</h1>
                </div>
            </div>
                            ...
                            @method('PATCH') 
                                <div class="form-group-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7">
                                            <input type="text" name="heading" value="{{$serv->heading}}" class="form-control" required/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7">
                                                <textarea name="description" value="{{$serv->description}}" class="form-control" rows="6" required>{{$serv->description}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7">
                                            <input type="file" name="icon" value="{{$serv->icon}}" class="form-control"/>                                            
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7">
                                                <img class="pull-left" src="{{ URL::asset('admin/img/'.$serv->icon) }}" width="150px" height="150px"/>                                              
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7">
                                                <div class="form-select-list">                                
                                                    <select class="form-control custom-select-value" name="status" value="{{$serv->status}}">
                                                        @if($serv->status=='active')
                                                        <option value="active" selected>active</option>
                                                        <option value="inactive">inactive</option>
                                                        @elseif($serv->status=='inactive')
